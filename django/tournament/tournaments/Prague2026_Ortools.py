...
tslug = "PIT2026"
tname = "PIT 2026 (NOT FINAL VERSION!)"
...
division_slug = 'U18'
division_config = divisions[division_slug]
U18_system = SingleGroupDivisionSystem(prague2026,division_config['name'],division_slug,len(division_config['teams']), final_for=6)
...
ts.schedule = ortools_scheduler(prague2026.id, num_slots=38, num_pitches=5, buffer_every_slots=15, preferred_pitches=preferred_pitches)
