...
class FourGroups15Teams(DivisionSystemBase):
    ...
    def _createSystem(self):
        ...
        # QF - 1. vs 2., 3. vs 4. + X3
        phase += 1
        self.division.CreateGroups(['X3','QF5','QF6'],self.division.GetGroupsRanks(['A','B','C','D'])[8:], phase)
        ...
        self.division.CreateGroups(['SF5'],self.division.GetGroupsRanks(['QF5','X3'])[:2], phase)
